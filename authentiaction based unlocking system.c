...
sbit rw = P3^1;
sbit en = P3^2;
//LCD user defined headder files//
...
void main()
{
lcdcmd(0x38);  //to configure the LCD for 2-line, 5×7 font and 8-bit operation mode
...
{
	unsigned int i;
	if(pwd[0]=='1'&&pwd[1]=='5'&&pwd[2]=='1'&&pwd[3]=='3')
	{
			
			lcdcmd(0x01); //clear screen
			lcddis(" ACCESS GRANTED...", 19);
			lcdcmd(0xc0);  //To pass to next line
			lcddis("   WELCOME TEAM   ", 20);
			i = 50;
			while(i--)
			{
